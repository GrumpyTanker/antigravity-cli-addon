...
ttyd -a -b /ttyd -t enableZmodem=true -t disableLeaveAlert=true -t disableResizeOverlay=true -t scrollback=100000 -t 'theme={"background": "#2b2b2b"}' -p 62900 /opt/antigravity/attach.sh &

echo "Starting NGINX reverse proxy on port 62901..."
